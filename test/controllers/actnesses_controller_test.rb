...
class ActnessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actness" do
    assert_difference('Actness.count') do
      post actnesses_url, params: { actness: { ball: @actness.ball, ball_strike: @actness.ball_strike, ball_type: @actness.ball_type, foul: @actness.foul, strike: @actness.strike, swing: @actness.swing } }
    end
  ...
  test "should update actness" do
    patch actness_url(@actness), params: { actness: { ball: @actness.ball, ball_strike: @actness.ball_strike, ball_type: @actness.ball_type, foul: @actness.foul, strike: @actness.strike, swing: @actness.swing } }
